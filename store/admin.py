...
# to show and manage the images on the admin interface(Product list)
...
class ProductAdmin(admin.ModelAdmin):
    ...
    # with this Media class i can specify what static assets that should be loaded on the product admin page
    class Media:
        css = {
