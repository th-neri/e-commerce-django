# Generated by Django 6.1.1 on 2026-09-16 01:51
...
class Migration(migrations.Migration):
    ...
    replaces = [('store', '0001_initial'), ('store', '0002_rename_price_to_unit_price'), ('store', '0003_add_slug_to_product'), ('store', '0004_add_zip_to_address'), ('store', '0005set_description_to_nullable_and_more'), ('store', '0006_set_featured_product_blank_to_true'), ('store', '0007_alter_orderitem_created_review_class'), ('store', '0008_alter_cart_id_default_value_uuid4'), ('store', '0009_alter_cartitem_added_related_name_and_unique_together'), ('store', '0010_alter_cartitem_quantity'), ('store', '0011_alter_customer_options_remove_customer_email_first_name_last_name_and_more'), ('store', '0012_added_permissions_order_table'), ('store', '0013_added_permissions_customer_table'), ('store', '0014_created_new_model_product_image')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custumer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.customer')),
